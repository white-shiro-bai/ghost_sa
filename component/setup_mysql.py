...
###注意，本方法仅限于测试MySQL5的环境，TiDB使用标准程序创建，可以支持更长的字符串###
...
CREATE TABLE if not EXISTS `mobile_ad_src` (
  ...
  `user_agent` varchar(767) DEFAULT NULL,
  ...
  `bot_name` varchar(200) DEFAULT NULL,
  `browser` varchar(200) DEFAULT NULL,
  `browser_version` varchar(200) DEFAULT NULL,
  `is_login_id` varchar(10) DEFAULT NULL,
  `screen_orientation` varchar(20) DEFAULT NULL,
  ...
  `first_referrer_host` varchar(200) DEFAULT NULL,
  `first_browser_language` varchar(200) DEFAULT NULL,
  `first_browser_charset` varchar(200) DEFAULT NULL,
  `first_search_keyword` varchar(200) DEFAULT NULL,
  `first_traffic_source_type` varchar(200) DEFAULT NULL,
  ...
  `latest_referrer` varchar(768) DEFAULT NULL,
  `latest_referrer_host` varchar(768) DEFAULT NULL,
...
if __name__ == "__main__":
    ...
    create_project(project_name='test_app3')
